...
// const fifteenCent = inventors.filter((inventor) => {
//     if (inventor.year >= 1500 && inventor.year < 1600) {
//         return true;
//     } 
// });

const fifteenCent = inventors.filter((inventor) => inventor.year >= 1500 && inventor.year < 1600);
console.table(fifteenCent);
...
const alphaSort = people.sort((lastItem, firstItem) => {
    const [aLast, aFirst] = lastItem.split(", ");
    const [bLast, bFirst] = firstItem.split(", ");
